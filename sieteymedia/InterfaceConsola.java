...
public class InterfaceConsola {
    ...
    Carta[] cartasJugador = juego.cartasJugador;
    Carta[] cartasBanca = juego.cartasBanca;
    Baraja baraja = juego.baraja;
    ...
    void turnoJugador() {
        ...
        while (juego.valorCartas(cartasJugador) < 7.5 && opc == 'C') {
            Carta c = baraja.darCartas(1)[0];
            // insertamos c en las cartas del jugador
            juego.insertarCartaEnArray(cartasJugador, c);
            ...
            double valor = juego.valorCartas(cartasJugador);
    ...
    void turnoBanca() {
        ...
        double valorCartasJugador = juego.valorCartas(cartasJugador);
        ...
        while (juego.valorCartas(cartasBanca) < valorCartasJugador) {
            Carta c = baraja.darCartas(1)[0];
            juego.insertarCartaEnArray(cartasBanca, c);
        }
        System.out.println("Éstas son mis cartas:");
        mostrarCartas(cartasBanca);
        System.out.println("\nValor de  mis cartas(banca): " + juego.valorCartas(cartasBanca));
        if (juego.valorCartas(cartasBanca) > 7.5) {
